...
function ==(p1::ECPointAffine, p2::ECPointProjective)
    return (p1.isId && p2.isId) || (p1.x*p2.z == p2.x && p1.y*p2.z == p2.y)
end
...
function ==(p1::ECPointAffine, p2::ECPointLD)
    return (p1.isId && p2.isId) || (p1.x*p2.z == p2.x && p1.y*p2.z^2 == p2.y)
end
...
function ==(p1::ECPointAffine, p2::ECPointJacobian)
    z2_2 = p2.z^2
    return (p1.isId && p2.isId) || (p1.x*z2_2 == p2.x && p1.y*p2.z*z2_2 == p2.y)
end
...
function ==(p1::ECPointProjective, p2::ECPointLD)
    return (p1.isId && p2.isId) || (p1.x*p2.z == p2.x*p1.z && p1.y*p2.z^2 == p2.y*p1.z)
end
...
function ==(p1::ECPointProjective, p2::ECPointJacobian)
    z2_2 = p2.z^2
    return (p1.isId && p2.isId) || (p1.x*z2_2 == p2.x*p1.z && p1.y*p2.z*z2_2 == p2.y*p1.z)
end
...
function ==(p1::ECPointLD, p2::ECPointJacobian)
    z2_2 = p2.z^2
    return (p1.isId && p2.isId) || (p1.x*z2_2 == p2.x*p1.z && p1.y*p2.z*z2_2 == p2.y*p1.z^2)
end
...
function +(::Type{ECPointJacobian}, p1::ECPointLD, p2::ECPointJacobian)
    ...
    if p2.isId return convert(ECPointJacobian, p1) end
...
function +(::Type{ECPointLD}, p1::ECPointLD, p2::ECPointJacobian)
    if p1.ec!=p2.ec throw(ECMismatchException()) end
    if p1.isId return convert(ECPointLD, p2) end
