...
const SECT163K1 = CurveDomainParams(
    ECPointAffine(
        ...
        EC(BFieldPoint163(1), BFieldPoint163(1))
    ),
...
const SECT163R1 = CurveDomainParams(
    ECPointAffine(
        ...
        EC(
            BFieldPoint163("07 B6882CAA EFA84F95 54FF8428 BD88E246 D2782AE2"),
            BFieldPoint163("07 13612DCD DCB40AAB 946BDA29 CA91F73A F958AFD9")
        )
    ),
...
const SECT163R2 = CurveDomainParams(
    ECPointAffine(
        ...
        EC(
            BFieldPoint163(1),
            BFieldPoint163("02 0A601907 B8C953CA 1481EB10 512F7874 4A3205FD")
        )
    ),
...
const SECT233R1 = CurveDomainParams(
    ECPointAffine(
        ...
        EC(
            BFieldPoint233(1),
            BFieldPoint233("0066 647EDE6C 332C7F8C 0923BB58 213B333B 20E9CE42 81FE115F 7D8F90AD")
        )
    ),
...
const SECT283R1 = CurveDomainParams(
    ECPointAffine(
        ...
        EC(
            BFieldPoint283(1),
            BFieldPoint283("027B680A C8B8596D A5A4AF8A 19A0303F CA97FD76 45309FA2 A581485A F6263E31 3B79A2F5")
        )
    ),
...
const SECT409R1 = CurveDomainParams(
    ECPointAffine(
        ...
        EC(
            BFieldPoint409(1),
            BFieldPoint409("0021A5C2 C8EE9FEB 5C4B9A75 3B7B476B 7FD6422E F1F3DD67 4761FA99 D6AC27C8 A9A197B2 72822F6C D57A55AA 4F50AE31 7B13545F")
        )
    ),
...
const SECT571R1 = CurveDomainParams(
    ECPointAffine(
        ...
        EC(
            BFieldPoint571(1),
            BFieldPoint571("02F40E7E 2221F295 DE297117 B7F3D62F 5C6A97FF CB8CEFF1 CD6BA8CE 4A9A18AD 84FFABBD 8EFA5933 2BE7AD67 56A66E29 4AFD185A 78FF12AA 520E4DE7 39BACA0C 7FFEFF7F 2955727A")
        )
    ),
